...
from ResNet50 import createModel4Training, createModel4Testing
...
def borrador(kfold_no, feature, disease, results_dir, kfold_dir):
    ...
    if kfold_no == 1:
        ...
        npzfile = np.load('./RESULTS/' + results_dir + 'RESULTS_' + disease + '_' + feature + '_ResNet50.npz')
    ...
    np.savez('./RESULTS/' + results_dir + 'RESULTS_' + disease + '_' + feature + '_Resnet50', RESULTS)
